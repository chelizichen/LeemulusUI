...
function SpecialWindowsView(props:windowProps)
{
    ...
    {
        width: width===undefined||width === null||width.toString.length===0?'100%':`${width}px`,
        height: height===undefined||height===null||height.toString.length===0?'100%':`${height}px`,
        // position: 'absolute',
        // left: '50%',
        // top: '50%',
    ...
    const contentStyle:CSSProperties={
            width:'100%',
            height: height===undefined||height===null||height.toString.length===0?'100%':`${height-30}px`,
